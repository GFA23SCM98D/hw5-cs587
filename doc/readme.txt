...
retrieve.ipynb can retrieve information of github repos and save it in a json file. 
plot.ipynb file can plot images about issues, issues created, issues closed, stars, forks, etc.
LSTM.ipynb, prophet.ipynb and statsmodel.ipynb can forecast the future trend of every repos. But they don't work now(I haven't fixed all bugs).
...
step3: Steps to create Gcloud Project
      ...
      d. Create a project named "hw5-cs587" and navigate to your newly generated project dashboard.
...
Step 4: To deploy application to gcloud platform:
  ...
  Step5: Set up GitHub
       ...
       c. Create a new repository named hw5-cs587 and keep everything set to defaults and click on create repository.
